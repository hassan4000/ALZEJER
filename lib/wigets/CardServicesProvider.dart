...
class CardServicesProvider extends StatelessWidget {
  UserInfoModel userInfoModel;
  VoidCallback pressShowProviderPage;
  VoidCallback pressShowPath;


  CardServicesProvider({this.userInfoModel,this.pressShowProviderPage,this.pressShowPath});
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              mainAxisSize: MainAxisSize.max,
              children: <Widget>[
                Flexible(flex: 1,child:MyButton(txt:connectTxt,press: pressShowPath,)),
                Expanded(
                  flex: 2,
                  child: Column(
