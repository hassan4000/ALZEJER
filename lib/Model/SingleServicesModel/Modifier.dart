class Modifier {
    ...
    Modifier({this.accessFailedCount, this.age, this.country, this.creationDate, this.email, this.emailConfirmed, this.fireBaseId, this.id, this.jobDescription, this.joiningDate, this.lastModificationDate, this.lockoutEnabled, this.lockoutEndDateUtc, this.martialStatus, this.name, this.numbOfDreamsInOneDay, this.online, this.passwordHash, this.personalDescription, this.phoneNumber, this.phoneNumberConfirmed, this.pictureId, this.pointsBalance, this.securityStamp, this.sex, this.socialState, this.status, this.twoFactorEnabled, this.type, this.userName, this.userRegistrationCode, this.userSpecialCode, this.userWorkBinding, this.verifiedInterpreter});
