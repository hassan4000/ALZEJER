...
import 'AllPaymentMethodPage.dart';

class PrivetOrPublicAfterAreYouHurry extends StatefulWidget {
  ...
  PrivetOrPublicAfterAreYouHurry({this.paymentModel,this.formAddsericesPage=false,this.addServiceModel});



  @override
  _PrivetOrPublicAfterAreYouHurryState createState() => _PrivetOrPublicAfterAreYouHurryState();
}

class _PrivetOrPublicAfterAreYouHurryState extends State<PrivetOrPublicAfterAreYouHurry> {
...
//      widget.addServiceModel.privateService=false;
    ...
    openPage(context,
        AllPaymentMethodPage(paymentModel: widget.paymentModel,
          addServiceModel: widget.addServiceModel,formAddSerives: widget.formAddsericesPage,));
